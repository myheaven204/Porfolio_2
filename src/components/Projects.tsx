        ...
        <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <AnimatePresence mode="popLayout">
            {displayedProjects.map((project, i) => (
                ...
                className="group relative rounded-xl overflow-hidden bg-surface border border-stroke cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
